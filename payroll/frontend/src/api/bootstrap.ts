...
interface AppDataResponse {
  success: boolean
  data: { employees: Employee[]; departments: Department[]; positions: Position[]; payroll_periods: PayrollPeriodRecord[]; pay_item_types: PayItemType[]; organizations: Organization[] }
}
